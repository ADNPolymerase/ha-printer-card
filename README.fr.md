...
- **Un bac vide se voit** : quand l'imprimante signale `media-empty` / `media-needed`, ou le dit avec ses mots, le bac arrière du jet d'encre est dessiné sans papier. Un bourrage n'est pas un bac vide, et garde sa pile.
