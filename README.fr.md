...
| `counters_align` | `left` (défaut) ou `center`. À plusieurs fonctions, les compteurs forment un tableau avec sa colonne de libellés, et la gauche est leur place. Une machine qui ne fait qu'imprimer n'a qu'une ligne nue, qui flotte sous une rangée de cartouches centrée ; `center` la remet dessous. |
